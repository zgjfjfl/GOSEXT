...
function zgZyra:CastRAoE(target)
	if IsReady(_R) then
...
function zgBrand:CastWAoE(target)
	if IsReady(_W) then
...
function zgVelkoz:BestAim(predictionPos)
...
function zgZiggs:CastRAoE(unit)
...
function zgSwain:CastWAoE(unit)
