...
Menu = {
    ...
    CreateGeneral = function(self)
        ...
        self.Main:MenuElement({id = 'CursorDelay', name = 'Cursor Delay', value = 50, min = 50, max = 100, step = 1})
...
Data = {
	...
	HeroCanMove = function(self)
		...
		if  Buff:HasBuffTypes(myHero, { [25] = true, [12] = true,  [5] = true }) then
			return false
		end
		return true
	end,
	...
	HeroCanAttack = function(self)
		...
		if  Buff:HasBuffTypes(myHero, { [32] = true, [25] = true, [5] = true }) or (Buff:HasBuffTypes(myHero, { [26] = true}) and myHero.charName~="Azir") then
			return false
		end
		return true
	end,
